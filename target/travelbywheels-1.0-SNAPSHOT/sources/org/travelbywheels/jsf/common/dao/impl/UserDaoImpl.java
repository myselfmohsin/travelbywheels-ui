...
public class UserDaoImpl implements UserDao {
    ...
    public UserData getUserData(String userEmail) {
        ...
        UserData userData = restTemplate.getForObject("http://localhost:9966/travelbywheels-rest/REST/user-services/"+ userEmail +"/", UserData.class);
    ...
    public Boolean isUserEmailExist(String userEmail) {
        Boolean isUserEmailExist = restTemplate.getForObject("http://localhost:9966/travelbywheels-rest/REST/user-services/"+ userEmail +"/check", Boolean.class);
        return isUserEmailExist;
    }

    @Override
    public UserData registerUser(UserData userData) {
            userData = restTemplate.postForObject("http://localhost:9966/travelbywheels-rest/REST/user-services/register-user", userData, UserData.class);
